...
public class MobConverter {
  ...
  private final String UNCOMMON_PREFIX = "&2";
  ...
  private final String RARE_PREFIX = "&1";
  ...
  private final String EPIC_PREFIX = "&5";
  ...
  private final String LEGEND_PREFIX = "&6";
  ...
  public void convertMob(Entity entity, String rarity) {
    ...
    switch (rarity) {
      case "uncommon" -> {
        ...
        en.getAttribute(Attribute.GENERIC_MAX_HEALTH)
                .setBaseValue(baseHealth * UNCOMMON_HEALTH_MULT);
        en.getAttribute(Attribute.GENERIC_ARMOR).setBaseValue(baseArmor + UNCOMMON_ARMOR);
        en.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE)
                .setBaseValue(baseDamage * UNCOMMON_DAMAGE_MULT);
        en.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED)
                .setBaseValue(baseMoveSpeed * UNCOMMON_MOVE_SPEED);
      ...
      case "rare" -> {
        ...
        en.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE)
                .setBaseValue(baseDamage * RARE_DAMAGE_MULT);
        en.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED)
                .setBaseValue(baseMoveSpeed * RARE_MOVE_SPEED);
        en.setHealth(en.getAttribute(Attribute.GENERIC_MAX_HEALTH).getBaseValue());
      ...
      case "epic" -> {
        ...
        en.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE)
                .setBaseValue(baseDamage * EPIC_DAMAGE_MULT);
        en.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED)
                .setBaseValue(baseMoveSpeed * EPIC_MOVE_SPEED);
        en.setHealth(en.getAttribute(Attribute.GENERIC_MAX_HEALTH).getBaseValue());
      ...
      case "legend" -> {
        ...
        en.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE)
                .setBaseValue(baseDamage * LEGEND_DAMAGE_MULT);
        en.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED)
                .setBaseValue(baseMoveSpeed * LEGEND_MOVE_SPEED);
        en.setHealth(en.getAttribute(Attribute.GENERIC_MAX_HEALTH).getBaseValue());
